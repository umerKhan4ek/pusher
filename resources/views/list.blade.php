...
{{-- 
    <script src="https://js.pusher.com/4.2/pusher.min.js"></script>
          ...
          <script type="text/javascript">
            ...
            // var channel2 = pusher.subscribe('private-counter');

            // channel2.bind('App\\Events\\Counter', function(data) {
            ...
            channel.bind('App\\Events\\Notification', function(data) {
                ...
                entry.appendChild(document.createTextNode(data.message+'-'+data.username));
